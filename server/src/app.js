// Restarting server to clear rate limiters
...
app.use("/api/v1/notifications", require("./routes/notificationRoutes"));
app.use("/api/v1/analytics", require("./routes/tenantAnalyticsRoutes"));
...
app.use("/api/v1/analytics", require("./routes/memberAnalyticsRoutes"));
